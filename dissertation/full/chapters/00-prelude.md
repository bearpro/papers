...
информационных технологий, процесс управления требованиями становится более
трудоёмким. Это создаёт потребность в автоматизации управления требованиями. В
том числе, процесс анализа нормативного окружения на предмет наличия
противоречий между нормативными документами, являясь одной из трудоёмких задач
управления требованиями, является особенно актуальным направлением
автоматизации.
